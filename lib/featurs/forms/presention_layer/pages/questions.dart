        ...
        child: Center(
          child: Container(
            ...
            child: Column(
              children: [
                SizedBox(height: 16,),
                Text(pleaseFilledIn,style: TextStyle(color: pink,fontFamily:"Josefin Sans", fontSize: 30, fontWeight: FontWeight.bold,shadows: [
                  BoxShadow(
                    color: brown,
                    offset: Offset(1,1),
                    spreadRadius: 0.0001,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text(data[0].questions[index],style: TextStyle(color: brown,fontFamily:"Josefin Sans", fontSize: 22, fontWeight: FontWeight.bold,shadows: [
                                        BoxShadow(
                                          color: brown,
                                          offset: Offset(1,1),
                                    ...
                                    TextFiledCustom( pink.withOpacity(0.3), 2, _textControllers[data[0].questions[index]]!)
                                  ],
                                ),
                              );
                            },
